...
#define WHITE_GRAY COLOR(20, 20, 20)
#define M_GRAY COLOR(10, 10, 10)
#define D_GRAY COLOR(3, 3, 3)

#define RED COLOR(31,0,0)
#define RED_1 COLOR(20,0,0)
#define RED_2 COLOR(10,0,0)

#define MAGENTA COLOR(31, 15, 31)
#define MAGENTA_1 COLOR(20, 10, 20)
#define MAGENTA_2 COLOR(10, 5, 10)

#define GREEN COLOR(0,31,0)
#define GREEN_1 COLOR(0,20,0)
#define GREEN_2 COLOR(0,10,0)

#define CYAN COLOR(0, 31, 31)
#define CYAN_1 COLOR(0, 20, 20)
#define CYAN_2 COLOR(0, 10, 10)

#define BLUE COLOR(10,10,31)
#define BLUE_1 COLOR(10,10,20)
#define BLUE_2 COLOR(10,10,15)
